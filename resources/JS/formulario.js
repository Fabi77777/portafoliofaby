...
const contact_name = document.getElementById("form-name");
    const contact_email = document.getElementById("form-email");
    const contact_message = document.getElementById("form-message");
...
const serviceID = 'service_flxib7n'; // cambiar por tu service ID - emailjs
const templateID = 'template_75a2ann';
...
submit.addEventListener('click', function (event) {
    ...
    if (isValid) {
      (function () {
        emailjs.init('48zPvJBfMO6gDzG_l');
      })();
